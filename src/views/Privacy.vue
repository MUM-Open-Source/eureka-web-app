<template>
    <div class="page-pad">
        ...
        <div class="mar__b--3">
            ...
            <div class="mar__b--1">
                At Eureka, accessible from www.eureka-monash.com, one of our
                ...
                and recorded by Eureka and how we use it.
            </div>
            ...
            <div>
                ...
                information that they shared and/or collect in Eureka. This
        ...
        <div class="mar__b--3">
            ...
            <div>
                Eureka follows a standard procedure of using log files. These
        ...
        <div class="mar__b--3">
            ...
            <div class="mar__b--1">
                Like any other website, Eureka uses 'cookies'. These cookies are
        ...
        <div class="mar__b--3">
            ...
            <div class="mar__b--1">
                Eureka's Privacy Policy does not apply to other advertisers or
        ...
        <div class="mar__b--3">
            ...
            <div>
                Eureka does not knowingly collect any Personal Identifiable
