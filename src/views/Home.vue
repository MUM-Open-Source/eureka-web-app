<template>
    ...
    <div class="page-pad">
        <div class="home__hero text--center">
            ...
            <div class="body home__subtitle mar__t--2 mar__b--2">
                ...
                University Malaysia Tech Club (MUMTEC) Community with whom you
                can team up, seek guidance or just simply say hi. We aim to make
                it easier to find people to join you on your unique adventures.
            </div>
        ...
        <div class="home__features">
            <div class="row">
                ...
                <div class="mar--auto">
                    ...
                    <div class="body mar__b--3">
                        Go through the list of events to find something you will
                        potentially be interested to take part in. You can find
                        upcoming hackathons, datathons, talks, workshops and
            ...
            <div class="row feature__order--unchanged">
                <div class="mar--auto">
                    ...
                    <div class="body mar__b--3">
                        Filter and team up with other like-minded students who
                        are just as passionate and ambitious as you. You might
                        just find your next teammate for a competition, personal
                        project and more!
                    </div>
                </div>
                <img
            ...
            <div class="row">
                ...
                <div class="mar--auto">
                    <div class="subheading mar__b--2">
                        A Place For Seniors And Alumni To Share Their Expertise
                    </div>
                    <div class="body mar__b--5">
                        Network with experienced members of the community who
                        are ready to guide you and your team. If you are
                        interested to be a mentor, do get in touch with our team
    ...
    <div class="home__develop text--center text--white page-pad">
        ...
        <div class="body mar__b--3">
            We're going Open Source soon and you'll be able to help build and
            add features to make this platform better! Built by the student
