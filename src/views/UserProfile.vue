            ...
            <div class="profile__content">
                <div class="profile__img text--center pad--4">
                    ...
                    <!-- <div class="profile__img--upload mar__t--1">
                        <form class="btn-chooseFile mar--2">
                            <label
                                for="imageUpload"
                                class="body custom-file-upload text--capsule cursor__pointer"
                            >
                                Update
                            </label>
                            <input
                ...
                <div class="profile__inputs--wrapper">
                    <div class="profile__inputs mar__t--3 mar__b--3">
                        ...
                        <div class="tagline skills__tagline">
                            You can enter values that aren't listed
                        </div>
                        <Multiselect
...
export default {
    ...
    setup() {
        ...
        const helper = {
            backgroundLabel: isUserTalent.value
                ? 'Current Degree*'
                : 'Degree / Job Title*',
            backgroundPlaceholder: isUserTalent.value
                ? 'Computer Science'
                : 'Software Engineer',
            skillsLabel: isUserTalent.value ? 'Interests*' : 'Skills*',
            skillsPlaceholder:
                'Enter upto 7 ' + (isUserTalent.value ? 'interests' : 'skills'),
        };
        ...
        function handleInputsUpdate() {
            state.hasUnsavedChanges =
                ...
                parseInt(inputValues.experience_level) !==
        ...
        const selectedInterests = computed(() =>
            JSON.parse(JSON.stringify(store.state.user_data.interests))
        );
        ...
        function handleImageUpload() {
            ...
            if (file) {
                if (validFileTypes.includes(file.type)) {
                    ...
                    store
                        .dispatch('uploadUserCroppedImage', {
                            file: file,
                            fileName: fileName,
                            metadata: metadata,
                        })
                    ...
                    Swal.fire({
                        ...
                        text: 'Please select an image with the right format',
                    });
                }
        ...
        function handleInfoUpdate() {
            if (allMandatoryFieldsFilled()) {
                Swal.fire({
                    ...
                    text:
                        'They are marked with an asterisk (*) for your convenience',
                });
                ...
                Swal.fire({
                    ...
                    text:
                        'Please follow the format https://www.______.com/_______',
                });
            } else {
