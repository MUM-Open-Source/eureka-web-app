    ...
    <div class="page-pad">
        ...
        <div class="mar__b--3">
            ...
            <div class="mar__b--1">
                ...
                the use of Eureka's Website, located at www.eureka-monash.com.
            </div>
            <div class="mar__b--1">
                By accessing this website we assume you accept these terms and
                conditions. Do not continue to use Eureka if you do not agree to
            ...
            <div>
                ...
                and subject to, prevailing law of Malaysia. Any use of the above
        ...
        <div class="mar__b--3">
            ...
            <div class="mar__b--1">
                We employ the use of cookies. By accessing Eureka, you agreed to
                use cookies in agreement with the Eureka's Privacy Policy.
            </div>
            <div class="mar__b--1">
        ...
        <div class="mar__b--3">
            ...
            <div class="mar__b--1">
                Unless otherwise stated, Eureka and/or its licensors own the
                intellectual property rights for all material on Eureka. All
                intellectual property rights are reserved. You may access this
                from Eureka for your own personal use subjected to restrictions
            ...
            <div class="mar__b--1">
                ...
                website. Eureka does not filter, edit, publish or review
                Comments prior to their presence on the website. Comments do not
                reflect the views and opinions of Eureka, its agents and/or
                affiliates. Comments reflect the views and opinions of the
                person who post their views and opinions. To the extent
                permitted by applicable laws, Eureka shall not be liable for the
            ...
            <div class="mar__b--1">
                Eureka reserves the right to monitor all Comments and to remove
            ...
            <div>
                You hereby grant Eureka a non-exclusive license to use,
        ...
        <div class="mar__b--3">
            ...
            <div class="mar__b--1">
                ...
                of Eureka; and (d) the link is in the context of general
            ...
            <div class="mar__b--1">
                ...
                by sending an e-mail to Eureka. Please include your name, your
            ...
            <div>
                No use of Eureka's logo or other artwork will be allowed for
