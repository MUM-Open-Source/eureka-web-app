<template>
    <div class="modal">
        ...
        <hr class="divider" />
        <div class="modal__body" :class="{ modal__noNotiStyle: !displayNotifications.length }">
            <NotificationsCategories :notifications="displayNotifications" :longNoti="false" v-if="displayNotifications.length" />
